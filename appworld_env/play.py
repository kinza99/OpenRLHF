...
def environment_func(responses, labels):
    """
...
def reward_func(labels, responses=None):
    """
...
def read_task_ids_from_jsonl(file_path, num_lines=1):
    task_ids = []
    messages=[]
...
if __name__ == "__main__":
    ...
    file_path = "/cpfs01/shared/llm_code/hesiyang/appworld_new/data/appworld_test_normal.jsonl"
    ...
    for i in range(2):
        for task_id in task_ids:
            labels.append({"experiment_name": experiment_name+str(i), "task_id": task_id})
